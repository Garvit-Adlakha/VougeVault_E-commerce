...
export const Model = () => {
  return (
    <div className="model h-screen bg-custom-gradient flex">
      {/* Left Section */}
      <div className="model-left flex-1 flex flex-col justify-center gap-5 pl-44 leading-tight">
        ...
        <button className="model-latest-btn flex justify-center items-center gap-4 w-80 h-16 rounded-full mt-5 bg-red-500 text-white text-xl font-medium">
          Latest collections
      ...
      {/* Right Section */}
      <div className="model-right flex-1 flex items-center justify-center">
