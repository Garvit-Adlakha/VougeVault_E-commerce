...
export const NewsLetter = () => {
  return (
    <div className="w-full max-w-4xl h-auto flex flex-col items-center justify-center mx-auto mb-24 px-4 sm:px-6 lg:px-12 bg-gradient-to-r from-black via-yellow-300 to-yellow-200  rounded-xl shadow-lg p-5">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center bg-white w-full max-w-3xl h-auto rounded-full border border-[#e3e3e3] shadow-md p-2 sm:p-4">
        ...
        />
        <button className="w-full sm:w-1/3 lg:w-1/4 h-12 sm:h-auto rounded-full bg-black text-yellow-400 text-base sm:text-lg font-semibold cursor-pointer mt-4 sm:mt-0 transition transform hover:scale-105 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-[#e1ffea22] focus:ring-offset-2 p-2">
          Subscribe
        </button>
      </div>
    </div>
